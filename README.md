...
📈 Total Casualties Analysis: The dashboard reveals that a staggering 408,504 casualties occurred after accidents during the two-year period
...
🩸 Casualties by accident severity Slight severity form the bulk of casualties 84.0% whereas there are only 1.7% Fatal severity casualties.

🛣️ Road Type Analysis: Maximum Casualties by Single Carriageway road type (304.2K) and Minimum by Slip road(4.6K)

🌧️ Casualties Distribution by Road Surface: Highest Distribution of total casualties on Dry road surfaces (272,386)

🏙️ Casualties Relation by Area/Location Urban areas form the majority of casualties after an accident (249.6K)

☀️ Casualties Distribution by light condtion: 298.2K of casulties take place in daylight condtion
